...
Dự án phân tích và dự báo chuỗi thời gian nồng độ bụi mịn PM2.5 tại Hà Nội. Dự án thực hiện đánh giá trên ba độ phân giải thời gian khác nhau (theo giờ, 6 giờ, và theo ngày) bằng cách sử dụng và so sánh các mô hình thống kê truyền thống (ARIMA/SARIMA) với các mô hình học máy/học sâu (XGBoost, LSTM), kết hợp kỹ thuật phân rã chuỗi thời gian MSTL.
